...
from .app import create_app, create_socketio, register_routes, create_services
...
class SentientServer:
    ...
    def create(self):
        ...
        self.system_manager, self.project_service, self.execution_service = create_services(self.config, self.app, self.socketio)
        ...
        self.broadcast_manager = BroadcastManager(self.socketio, self.system_manager, self.project_service)
