...
class ExecutionOrchestrator:
    ...
    async def _initialize_root_task(self, root_goal: str) -> Optional[TaskNode]:
        ...
        try:
            ...
            if 'debug' in root_node.goal.lower():
                root_node.task_type = TaskType.THINK
                root_node.agent_name = 'DebuggerAgent'
                logger.info(f"Root debug goal detected - forcing THINK/DebuggerAgent for {root_node.task_id}")
