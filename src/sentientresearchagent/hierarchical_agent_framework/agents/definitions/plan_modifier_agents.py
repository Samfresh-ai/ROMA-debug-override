...
try:
    ...
    model_instance = LiteLLM(
        id=os.getenv("LITELLM_MODEL_ID", "fireworks_ai/accounts/fireworks/models/llama-v3-70b-instruct"),
    )
    ...
    print(f"Successfully initialized {PLAN_MODIFIER_AGENT_NAME} with model {os.getenv('LITELLM_MODEL_ID')}")
